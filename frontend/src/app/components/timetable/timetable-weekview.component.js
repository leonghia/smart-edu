export class TimetableWeekViewComponent extends HTMLElement {
    ...
    <div class="flex h-full flex-col">
        ...
        <div class="isolate flex flex-auto flex-col overflow-auto bg-white bg-opacity-70 dark:bg-gray-800">
...
customElements.define("timetable-weekview", TimetableWeekViewComponent);