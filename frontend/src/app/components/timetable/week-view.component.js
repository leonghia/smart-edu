export class TimetableWeekViewComponent extends HTMLElement {
    constructor() {
        super();
    }
    ...
    #render() {
        return `
    <div class="flex h-full flex-col shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px]" style="max-height:85vh;">
        <header class="flex flex-none items-center justify-between border-b border-gray-200 px-6 py-4 bg-gray-200 rounded-t-lg">
          ...
          <div class="flex items-center">
            ...
            <div class="hidden md:ml-4 md:flex md:items-center">
              <div class="relative">
                ...
                -->
                <div class="opacity-0 absolute right-0 z-10 mt-3 w-36 origin-top-right overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
              ...
              <button type="button" class="ml-6 rounded-md bg-fuchsia-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-fuchsia-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-fuchsia-500">Add reminder</button>
            </div>
        ...
        <div class="isolate flex flex-auto flex-col overflow-auto bg-white rounded-b-lg">
          <div style="width: 165%" class="flex max-w-full flex-none flex-col sm:max-w-none md:max-w-full">
            <div class="sticky top-0 z-30 flex-none bg-white shadow ring-1 ring-black ring-opacity-5 sm:pr-8">
              <div class="grid grid-cols-7 text-sm leading-6 text-gray-500 sm:hidden">
                ...
                <button type="button" class="flex flex-col items-center pb-3 pt-2">W <span class="mt-1 flex h-8 w-8 items-center justify-center rounded-full bg-fuchsia-600 font-semibold text-white">12</span></button>
              ...
              <div class="-mr-px hidden grid-cols-7 divide-x divide-gray-100 border-r border-gray-100 text-sm leading-6 text-gray-500 sm:grid">
                ...
                <div class="flex items-center justify-center py-3">
                  <span class="flex items-baseline">Wed <span class="ml-1.5 flex h-8 w-8 items-center justify-center rounded-full bg-fuchsia-600 font-semibold text-white">12</span></span>
                </div>
                <div class="flex items-center justify-center py-3">
            ...
            <div class="flex flex-auto">
              ...
              <div class="grid flex-auto grid-cols-1 grid-rows-1">
                <!-- Horizontal lines -->
                <div class="col-start-1 col-end-2 row-start-1 grid divide-y divide-gray-100" style="grid-template-rows: repeat(24, minmax(3.5rem, 1fr))">
                ...
                <!-- Events -->
                <ol class="col-start-1 col-end-2 row-start-1 grid grid-cols-1 sm:grid-cols-7 sm:pr-8" style="grid-template-rows: 1.85rem repeat(144, minmax(0, 1fr)) auto">
                  <li class="relative mt-px flex sm:col-start-1" style="grid-row: 5 / span 12">
                    <a href="#" class="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-blue-50 p-2 text-xs leading-5 hover:bg-blue-100">
                      <p class="order-1 font-semibold text-blue-700">Maths</p>
                      <p class="text-blue-500 group-hover:text-blue-700"><time datetime="2022-01-12T07:030">7:30 AM</time></p>
                    </a>
                  </li>
                  <li class="relative mt-px flex sm:col-start-1" style="grid-row: 17 / span 12">
                    <a href="#" class="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-pink-50 p-2 text-xs leading-5 hover:bg-pink-100">
                      <p class="order-1 font-semibold text-pink-700">English</p>
                      <p class="text-pink-500 group-hover:text-pink-700"><time datetime="2022-01-12T08:00">8:00 AM</time></p>
                    </a>
                  </li>
                  <li class="relative mt-px hidden sm:col-start-1 sm:flex" style="grid-row: 29 / span 12">
                    <a href="#" class="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-gray-100 p-2 text-xs leading-5 hover:bg-gray-200">
                      <p class="order-1 font-semibold text-gray-700">English</p>
                      <p class="text-gray-500 group-hover:text-gray-700"><time datetime="2022-01-15T10:00">9:00 AM</time></p>
                    </a>
                  </li>
                </ol>
              </div>
...
customElements.define("timetable-week-view", TimetableWeekViewComponent);