...
export class StudentSidebarComponent extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.#sidebarContainer.addEventListener("click", function (event) {
            ...
            links.forEach(a => {
                a.classList.remove(..."bg-gray-800 text-white".split(" "));
                a.classList.add(..."text-gray-400 hover:text-white hover:bg-gray-800".split(" "));
            });
            clicked.classList.remove(..."text-gray-400 hover:text-white hover:bg-gray-800".split(" "));
            clicked.classList.add(..."bg-gray-800 text-white".split(" "));
    ...
    #render() {
        return `
    <div
        class="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:block lg:w-20 lg:overflow-y-auto lg:bg-gray-900 lg:pb-4 sidebar">
