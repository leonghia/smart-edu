...
export class StudentSidebarComponent extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.#sidebarContainer.addEventListener("click", function (event) {
            ...
            links.forEach(a => {
                a.classList.remove(..."bg-gray-300 text-white".split(" "));
                a.classList.add(..."text-gray-400 hover:text-white hover:bg-gray-300".split(" "));
            });
            clicked.classList.remove(..."text-gray-400 hover:text-white hover:bg-gray-300".split(" "));
            clicked.classList.add(..."bg-gray-300 text-white".split(" "));
    ...
    #render() {
        return `
    <div
        class="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:block lg:w-20 lg:overflow-y-auto bg-gray-100 lg:pb-4 sidebar">
            ...
            <ul role="list" class="flex flex-col items-center space-y-1 sidebar-container">
                <li>
                    ...
                    <a href="#" id="sidebar_item_0"
                        class="text-gray-400 hover:text-white hover:bg-gray-300 dark:hover:bg-gray-800 group flex gap-x-3 rounded-md p-3 text-sm leading-6 font-semibold">               
