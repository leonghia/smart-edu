...
namespace SmartEdu.Controllers
{
    ...
    public class ExtraClassController : BaseController<ExtraClass>
    {
        ...
        {
            return await base.GetAll<GetExtraClassDTO>(requestParams, null, null, new List<string> { "Subject" });
        }
        ...
        {
            return await base.GetSingle<GetExtraClassDTO>(e => e.Id == id, new List<string> { "Subject" });
        }
        ...
        {
            return await base.Update<UpdateExtraClassDTO>(e => e.Id == id, updateExtraClassDTO);
        }
